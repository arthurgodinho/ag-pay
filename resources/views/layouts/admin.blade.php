...
<head>
    ...
    <script>
        {!! ThemeHelper::generateTailwindConfig() !!}
    </script>
    ...
    <div class="flex h-screen overflow-hidden">
            ...
            <div class="flex flex-col h-full bg-white rounded-r-lg border-r border-slate-200 shadow-2xl">
                ...
                <div class="flex items-center justify-between h-16 px-6 border-b border-slate-100">
                    <div class="flex items-center gap-2">
                        @if($logoUrl)
                            ...
                            <span class="text-xs text-theme-primary font-medium">Admin</span>
                        @else
                            <h1 class="text-2xl font-bold text-slate-800">{{ $systemName }} <span class="text-xs text-theme-primary font-medium">Admin</span></h1>
                        @endif
                    </div>
                    <button 
                ...
                <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto custom-scrollbar">
                    <a 
                        ...
                        class="flex items-center px-4 py-3 rounded-lg hover:bg-slate-50 hover:text-slate-900 transition-colors {{ request()->routeIs('admin.dashboard') ? 'bg-theme-primary/10 text-theme-primary font-medium' : 'text-slate-500' }}"
                    >
                    ...
                    <a 
                        ...
                        class="flex items-center px-4 py-3 text-slate-500 rounded-lg hover:bg-slate-50 hover:text-slate-900 transition-colors {{ request()->routeIs('admin.gateways.*') ? 'bg-theme-primary/10 text-theme-primary font-medium' : '' }}"
                    >
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a 
                        ...
                        class="flex items-center px-4 py-3 text-slate-500 rounded-lg hover:bg-slate-50 hover:text-slate-900 transition-colors {{ request()->routeIs('admin.kyc.*') ? 'bg-theme-primary/10 text-theme-primary font-medium' : '' }}"
                    >
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        @endphp
                        @if($pendingKyc > 0)
                            <span class="ml-auto text-white text-xs font-bold rounded-full min-w-[20px] h-5 px-1.5 flex items-center justify-center bg-theme-primary">{{ $pendingKyc }}</span>
                        @endif
                    </a>

                    <a 
                        href="{{ route('admin.users.index') }}" 
                        class="flex items-center px-4 py-3 text-slate-500 rounded-lg hover:bg-slate-50 hover:text-slate-900 transition-colors {{ request()->routeIs('admin.users.*') ? 'bg-theme-primary/10 text-theme-primary font-medium' : '' }}"
                    >
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a 
                        ...
                        class="flex items-center px-4 py-3 text-slate-500 rounded-lg hover:bg-slate-50 hover:text-slate-900 transition-colors {{ request()->routeIs('admin.transactions.*') ? 'bg-theme-primary/10 text-theme-primary font-medium' : '' }}"
                    >
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a 
                        ...
                        class="flex items-center px-4 py-3 text-slate-500 rounded-lg hover:bg-slate-50 hover:text-slate-900 transition-colors {{ request()->routeIs('admin.withdrawals.*') ? 'bg-theme-primary/10 text-theme-primary font-medium' : '' }}"
                    >
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        @if($pendingWithdrawals > 0)
                            <span class="ml-auto text-white text-xs font-bold rounded-full min-w-[20px] h-5 px-1.5 flex items-center justify-center bg-theme-primary">{{ $pendingWithdrawals }}</span>
                        @endif
                    </a>

                    <a 
                        href="{{ route('admin.chargebacks.index') }}" 
                        class="flex items-center px-4 py-3 text-slate-500 rounded-lg hover:bg-slate-50 hover:text-slate-900 transition-colors {{ request()->routeIs('admin.chargebacks.*') ? 'bg-theme-primary/10 text-theme-primary font-medium' : '' }}"
                    >
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        @if($pendingChargebacks > 0)
                            <span class="ml-auto text-white text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center bg-theme-primary">{{ $pendingChargebacks }}</span>
                        @endif
                    </a>

                    <a 
                        href="{{ route('admin.support.index') }}" 
                        class="flex items-center px-4 py-3 text-slate-500 rounded-lg hover:bg-slate-50 hover:text-slate-900 transition-colors {{ request()->routeIs('admin.support.*') ? 'bg-theme-primary/10 text-theme-primary font-medium' : '' }}"
                    >
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a 
                        ...
                        class="flex items-center px-4 py-3 text-slate-500 rounded-lg hover:bg-slate-50 hover:text-slate-900 transition-colors {{ request()->routeIs('admin.configs.*') ? 'bg-theme-primary/10 text-theme-primary font-medium' : '' }}"
                    >
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"></path>
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                    ...
                    <a 
                        ...
                        class="flex items-center px-4 py-3 text-slate-500 rounded-lg hover:bg-slate-50 hover:text-slate-900 transition-colors {{ request()->routeIs('admin.smtp.*') ? 'bg-theme-primary/10 text-theme-primary font-medium' : '' }}"
                    >
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a 
                        ...
                        class="flex items-center px-4 py-3 text-slate-500 rounded-lg hover:bg-slate-50 hover:text-slate-900 transition-colors {{ request()->routeIs('admin.email-campaigns.*') ? 'bg-theme-primary/10 text-theme-primary font-medium' : '' }}"
                    >
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a 
                        ...
                        class="flex items-center px-4 py-3 text-slate-500 rounded-lg hover:bg-slate-50 hover:text-slate-900 transition-colors {{ request()->routeIs('admin.awards.*') ? 'bg-theme-primary/10 text-theme-primary font-medium' : '' }}"
                    >
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a 
                        ...
                        class="flex items-center px-4 py-3 text-slate-500 rounded-lg hover:bg-slate-50 hover:text-slate-900 transition-colors {{ request()->routeIs('admin.landing.*') ? 'bg-theme-primary/10 text-theme-primary font-medium' : '' }}"
                    >
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a 
                        ...
                        class="flex items-center px-4 py-3 text-slate-500 rounded-lg hover:bg-slate-50 hover:text-slate-900 transition-colors {{ request()->routeIs('admin.static.*') ? 'bg-theme-primary/10 text-theme-primary font-medium' : '' }}"
                    >
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
                    ...
                    <div class="relative">
                        ...
                        >
                            <div class="text-right hidden sm:block">
                                ...
                                <p class="text-xs text-theme-primary font-medium">Administrador</p>
                            </div>
                            ...
                            @else
                                <div class="w-10 h-10 rounded-full flex items-center justify-center text-white font-semibold bg-theme-primary shadow-md border-2 border-white">
            ...
            <main class="flex-1 overflow-y-auto p-8 bg-slate-50 custom-scrollbar">
                @if(session('success'))
                    <div class="mb-6 px-4 py-3 rounded-lg bg-theme-primary/20 border border-emerald-500/50 text-blue-400">
                        {{ session('success') }}
                    </div>
                @endif
