...
<div class="max-w-3xl mx-auto space-y-6">
    <div class="flex items-center gap-4">
        ...
        <h1 class="text-3xl font-bold text-slate-900">Novo Prêmio</h1>
    </div>
        ...
        <form action="{{ route('admin.awards.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="title" id="title" required 
                           ...
                           placeholder="Ex: Placa de 100k">
                </div>

                <!-- Meta de Saldo -->
                <div class="space-y-2">
                    <label for="goal_amount" class="text-sm font-bold text-slate-700">Meta de Saldo (R$)</label>
                    <input type="number" name="goal_amount" id="goal_amount" required step="0.01" min="0"
                           class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
            ...
            <div class="space-y-2">
                ...
                <textarea name="description" id="description" required rows="3"
                          class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                          placeholder="Ex: Prêmio exclusivo para quem atingir R$ 100.000,00 em vendas acumuladas."></textarea>
            </div>

            <!-- Imagem -->
            <div class="space-y-2">
                <label for="image" class="text-sm font-bold text-slate-700">Imagem do Prêmio <span class="text-red-500">*</span></label>
                ...
                <div class="border-2 border-dashed border-slate-200 rounded-xl p-6 text-center hover:bg-slate-50 transition-colors cursor-pointer relative @error('image') border-red-300 bg-red-50 @enderror">
                    ...
                    <div id="image-preview" class="hidden mb-4">
                        <img src="" alt="Preview" class="mx-auto h-32 object-contain rounded-lg shadow-sm">
                    </div>
                    <div id="image-placeholder">
                        <svg class="mx-auto h-12 w-12 text-slate-400" stroke="currentColor" fill="none" viewBox="0 0 48 48">
                            <path d="M28 8H12a4 4 0 00-4 4v20m32-12v8m0 0v8a4 4 0 01-4 4H12a4 4 0 01-4-4v-4m32-4l-3.172-3.172a4 4 0 00-5.656 0L28 28M8 32l9.172-9.172a4 4 0 015.656 0L28 28m0 0l4 4m4-24h8m-4-4v8m-12 4h.02" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                        <p class="mt-1 text-sm text-slate-500">Clique para selecionar uma imagem</p>
